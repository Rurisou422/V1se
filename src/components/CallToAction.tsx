      ...
      >
        ...
        <div className="mt-8">
          <motion.button
            ...
            className="px-8 py-3 bg-blue-600/20 hover:bg-blue-600/30 rounded-full font-medium transition-colors border border-blue-500/20 text-blue-400 shadow-[0_0_15px_rgba(59,130,246,0.2)] flex items-center justify-center mx-auto"
          >
